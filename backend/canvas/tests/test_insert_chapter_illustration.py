...
from app.models.chapter_illustration import ChapterIllustration

it = importlib.import_module("app.services.agents.tools.illustration_tools")
svc = importlib.import_module("app.services.chapter_illustration_service")
